...
export abstract class TestSuiteReport implements ReadStream<TestCaseReport> {
   ...
   */
  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : TestSuiteReport;

  /* override */ handler(handler: ((res: TestCaseReport) => void) | Handler<TestCaseReport> | null | undefined) : TestSuiteReport;

  /* override */ pause() : TestSuiteReport;

  /* override */ resume() : TestSuiteReport;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : TestSuiteReport;
}
