...
public class TaskObjectInstance extends ElementInstanceBase {	
	  ...
	  /**
	   * Default constructor using data
	   * @param data the data for the Task
	   * @param source the Source Study
	   */
	   ...
	   * @return the type (language and version) of the code
	   */
	   ...
	   * @return the outputs generated by the task
	   */
	   ...
	   * @param outputs the new Outputs set for the task (JsonArray of IDs)
	   */
	  ...
	  /**
	   * Set the outputs generated by this task
	   * @param persistent the ids of the persistent data
	   */
	 ...
	 * @return the {@link FieldSpecifications} for a Task
	 */
