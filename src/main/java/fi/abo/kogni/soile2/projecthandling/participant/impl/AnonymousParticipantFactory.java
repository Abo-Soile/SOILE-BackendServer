 ...
 *
 */
public class AnonymousParticipantFactory implements ParticipantFactory{
	
	ParticipantManager manager;
	public AnonymousParticipantFactory(ParticipantManager client)
	{
		this.manager = client;
	}
	...
	public Participant createParticipant(JsonObject data) {
		return new AnonymousParticipant(data, manager);
	}
