...
import fi.abo.kogni.soile2.project.instance.ProjectHandler;
...
public class ParticipantHandler {
	...
	public ParticipantHandler(MongoClient client, ProjectHandler project, ParticipantManager manager, Vertx vertx) {
		super();		
		this.client = client;
