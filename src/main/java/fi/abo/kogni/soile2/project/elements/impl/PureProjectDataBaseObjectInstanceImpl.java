 ...
 *
 */
public abstract class PureProjectDataBaseObjectInstanceImpl implements ProjectDataBaseObjectInstance {

	ProjectInstance sourceProject;
	JsonObject data;
	public PureProjectDataBaseObjectInstanceImpl(JsonObject data, ProjectInstance source)
	{
		this.data = data;
