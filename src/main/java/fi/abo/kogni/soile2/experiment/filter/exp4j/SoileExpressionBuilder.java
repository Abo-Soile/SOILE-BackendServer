...
import fi.abo.kogni.soile2.experiment.filter.exp4j.functions.*;
 ...
 */
public class SoileExpressionBuilder {
     ...
     */
    public SoileExpressionBuilder(String expression) {
        ...
        functions(new MaxFunction(), new MinFunction(), new MedianFunction(), new MeanFunction());
    }
     ...
     */
    public SoileExpressionBuilder function(Function function) {
     ...
     * @return the ExpressionBuilder instance
     */
    public SoileExpressionBuilder functions(Function... functions) {
     ...
     * @return the ExpressionBuilder instance
     */
    public SoileExpressionBuilder functions(List<Function> functions) {
        for (Function f : functions) {
            this.userFunctions.put(f.getName(), f);
        }
        return this;
     ...
     * @return the ExpressionBuilder instance
     */
    public SoileExpressionBuilder variables(Set<String> variableNames) {
     ...
     * @return the ExpressionBuilder instance
     */
    public SoileExpressionBuilder variables(String... variableNames) {
     ...
     * @return the ExpressionBuilder instance
     */
    public SoileExpressionBuilder variable(String variableName) {
        this.variableNames.add(variableName);
        return this;
    }

    public SoileExpressionBuilder implicitMultiplication(boolean enabled) {
     ...
     * @return the ExpressionBuilder instance
     */
    public SoileExpressionBuilder operator(Operator operator) {
     ...
     * @return the ExpressionBuilder instance
     */
    public SoileExpressionBuilder operator(Operator... operators) {
     ...
     * @return the ExpressionBuilder instance
     */
    public SoileExpressionBuilder operator(List<Operator> operators) {
        for (Operator o : operators) {
            this.operator(o);
        }
        return this;
    ...
    public SoileExpression build() {
        ...
        return new SoileExpression(ShuntingYard.convertToRPN(this.expression, this.userFunctions, this.userOperators,
