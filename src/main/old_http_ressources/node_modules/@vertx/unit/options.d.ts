...
export class ReportOptions {
  ...
  constructor(obj: ReportOptions | { [key: string]: any });
...
export class ReportingOptions {
  ...
  constructor(obj: ReportingOptions | { [key: string]: any });
 ...
 * </ul>
 */
export class TestOptions extends ReportingOptions {

  constructor();

  constructor(obj: TestOptions | { [key: string]: any });

  /**
   * Replace the current list of reporters with a new one.
   */
  /* override */ getReporters(): ReportOptions[];

  /**
   * Replace the current list of reporters with a new one.
   */
  /* override */ setReporters(reporters: ReportOptions[]): TestOptions;

  /**
   * Replace the current list of reporters with a new one.
   */
  /* override */ addReporter(reporters: ReportOptions): TestOptions;
